...
extern void Fix2String(uint32_t position, uint8_t *pt);
...
//    The next five characters after the ‘<’ should be the ASCII representation of thez distance
...
//6) increme/nt a TxCounter, used as debugging monitor of the number of ADC samples collected 
//7) toggle a heartbeat 
	GPIO_PORTF_DATA_R ^= 0x02; // toggle PF1
  Data = ADC_In(); // new data
